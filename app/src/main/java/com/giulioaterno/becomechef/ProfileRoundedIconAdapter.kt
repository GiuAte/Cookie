...
class ProfileRoundedIconAdapter(val usernames: List<ProfileRoundedIcon>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfileViewHolder {
        val view = BestChefRecyclerViewItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
